...
[source, bash]
----
mvn release:prepare release:perform -Pnative,release
----
...
Publish release on GitHub by running in https://github.com/yupiik/yupiik.github.io project:

[source, bash]
----
mvn yupiik-tools:synchronize-github-releases@yuc -Psynchronize-github-releases
----
